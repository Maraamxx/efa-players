            ...
            <div style={{ marginTop: 'auto', marginBottom: 'auto', background: 'var(--bg)', borderRadius: 12, border: '1px solid var(--border)', width: '100%', maxWidth: 520, animation: 'modalIn .2s ease' }} onClick={e => e.stopPropagation()}>
              ...
              <div style={{ borderTop: '1px solid var(--border)', padding: '16px 20px', display: 'flex', flexDirection: 'column', gap: 14 }}>
                ...
                <div>
                  ...
                  <select value={draft.leagueId} onChange={e => setDraft(d => ({ ...d, leagueId: e.target.value }))}
                    style={{ ...inp(errors.leagueId), cursor: 'pointer' }}>
                ...
                <div>
                  ...
                  <div style={{ ...inp(), display: 'flex', alignItems: 'center', gap: 8, color: 'var(--t2)', pointerEvents: 'none', height: 40 }}>
                    <img src="https://flagcdn.com/20x15/eg.png" alt="EG" style={{ borderRadius: 2 }} />
                    Egypt
                  </div>
                </div>
              </div>
