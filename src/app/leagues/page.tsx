...
export default function LeaguesPage() {
  ...
  const uniqueCountries = useMemo(() => [...new Set(leagues.map(l => l.country))].sort(), [leagues])
  const uniqueSeasons = useMemo(() => [...new Set(leagues.map(l => l.season))].sort().reverse(), [leagues])
